...
    
	...
	window.member_edit = function (obj,id) {
		...
		WeAdminShow('编辑留言资料', './Edit-video.html', 500, 400);
	}
	 //查看
	 window.member_show = function (obj,id) {
		...
		WeAdminShow('查看留言资料', './Show-video.html', 500, 400);
	}
