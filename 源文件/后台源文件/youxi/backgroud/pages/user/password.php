...
$sql1="SELECT Personalld FROM username WHERE PersonalPassword ='$PersonalPassword' ";
...
$sql ="UPDATE username SET PersonalPassword = '$Pass' WHERE PersonalPassword ='$PersonalPassword'  ";
$sqli ="INSERT INTO sever (operation,admin,object,place,time) VALUES ('修改密码','$admin','$id','用户管理/用户列表','$time')";
