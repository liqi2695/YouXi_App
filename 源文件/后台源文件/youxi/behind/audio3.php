...
$sql = "select PersonalNickName,PictureNumber,Time,Position,RandomPictureUrl,VideosTitle,AudioUrl,PriseNumber from audio where PersonalPhone ='$PersonalPhone' and judge ='1'";
// $sql = " select PersonalNickName,PictureNumber,Time,Position,RandomPictureUrl,VideosTitle,AudioUrl  from audio where judge ='1' order by audioid desc LIMIT 5";
